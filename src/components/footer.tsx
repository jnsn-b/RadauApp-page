      ...
      <div className="max-w-6xl mx-auto py-12 px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-2">
            <h3 className="text-xl font-bold font-headline text-primary">Radau Recreation</h3>
            <p className="text-muted-foreground">A digital agency.</p>
          </div>
          <div className="space-y-2">
            <h4 className="font-semibold font-headline">Contact</h4>
            <a href="mailto:hello@radau.recreation" className="block text-muted-foreground hover:text-primary">
              hello@radau.recreation
            </a>
          </div>
          <div className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Radau Recreation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
